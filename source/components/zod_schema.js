...
// 设计权威：source/card/玩法设计.md（容器：环境 / 角色）
...
try {
  ({ registerMvuSchema } = await import(
    'https://cdn.jsdelivr.net/gh/StageDog/tavern_resource@61e30e9cc69e89bcc9725c57df941175249c566a/dist/util/mvu_zod.js'
  ));
} catch (error) {
  ({ registerMvuSchema } = await import(
    'https://testingcf.jsdelivr.net/gh/StageDog/tavern_resource@61e30e9cc69e89bcc9725c57df941175249c566a/dist/util/mvu_zod.js'
  ));
}

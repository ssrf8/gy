...
中元节夜，{{user}}手中的祖传玉佩忽然发烫，两道虚影浮出——丹凤眼长髯者按刀而立，黑面执鞭者拱手而立。玉佩在等{{user}}选一位守护灵。人间香火，都认这块玉。
```
...
| ~~家族条目×4~~ | 已删除（2026-08-26 大改确认不再复用） | — |
...
> 四家（王/李/张/陈）条目已于 v0.2.1 拍板移除，源文件于 2026-08-26 大改删除，不再配置；未来填入的家族/组织条目走绿灯（见世界书布局.md）。

...
| 项 | 内容 | 位置 |
|---|---|---|
| 备选开场白 | source/card/openings/（每灵 1 条，含归属标记行，见玩法设计 §3.1/§6） | 角色卡编辑器「备选开场白」 |
| 守护灵条目×2 | entries/[mvu_plot] 守护灵·关羽/赵公明.md | 角色卡绑定世界书 |
| ~~家族条目×4~~ | 已移除（v0.2.1 拍板，entries/ 留档不组装） | — |
...
> 守护灵条目标题（comment）必须包含「关羽」/「赵公明」（开局页按标题开关；组装脚本已自动写入）。
> 四家（王/李/张/陈）条目已于 v0.2.1 拍板移除，不再配置；未来填入的家族/组织条目走绿灯（见世界书布局.md）。
